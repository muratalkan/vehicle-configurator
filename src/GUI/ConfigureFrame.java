...
public class ConfigureFrame extends javax.swing.JFrame {
    ...
    public ConfigureFrame(MainFrame vmf) {
        ...
        ImageIcon cVector = new ImageIcon("assets/images/typeVectors/" + type + ".png");
        vehicleTypeLogo.setIcon(cVector);
        ImageIcon vLogo = new ImageIcon("assets/images/brandLogos/" + brand + ".png");
    ...
    public static void readCarPackagesFile(){
        ...
        File vehicleTxt = new File("assets/data/CarPackages.txt");
        Scanner sc=null;
        try{
