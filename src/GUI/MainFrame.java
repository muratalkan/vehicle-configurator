...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
      this.getContentPane().setBackground(Color.gray);
        ...
        ImageIcon mLogo = new ImageIcon("assets/images/mainLogo.png");
    ...
    private boolean validation(){
        ...
        if(custName.getText().isEmpty() || custSurname.getText().isEmpty() || custPhone.getText().isEmpty() || !MainFrame.filled) {
    ...
    private void initComponents() {
        ...
        confButton.setMaximumSize(new java.awt.Dimension(100, 23));
        confButton.setMinimumSize(new java.awt.Dimension(100, 23));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(124, 124, 124)
                        .addComponent(confButton, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(36, 36, 36)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void ordersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ordersButtonActionPerformed
          ...
          if(validation()){
            DisplayFrame.setCustInfo(custName.getText(), custSurname.getText(), custPhone.getText());
              ...
              if(!(MainFrame.controlFrame)){
                vdispF = new DisplayFrame(this);
                vdispF .setVisible(true);
                msgLabel.setText("");
               
               MainFrame.controlFrame = true;
           }
           else
    ...
    private void confButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confButtonActionPerformed
     ...
     if(validation()){
          ConfigureFrame.setVehicleInfo(custName.getText(), custSurname.getText(), custPhone.getText(), 
            vTypeBox.getSelectedItem().toString(), vBrandBox.getSelectedItem().toString(),  vModelBox.getSelectedItem().toString(), MainFrame.basePrice);
            
            ConfigureFrame.readCarPackagesFile();
            
           if(!(MainFrame.controlFrame)){ // prevent creating multiple frames
                 ...
                 String selectedModel = vModelBox.getSelectedItem().toString();
                    ...
                    for(Vehicle v: vList)
                      if(v.getType().equals(selectedType) && v.getBrand().equals(selectedBrand) && v.getModel().equals(selectedModel))
                         MainFrame.basePrice = v.getBasePrice();
                    price = MainFrame.basePrice;
             vBasePrice.setText(String.format("%,.0f", price) + "$");
            }
            else 
                MainFrame.filled = false;
